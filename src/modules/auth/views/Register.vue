<template >
    ...
    <form  class="login100-form validate-form p-b-33 p-t-5"
        ...
        <div class="wrap-input100 validate-input" data-validate = "Ingrese su nombre">
            <input v-model="userFrom.name" class="input100" type="text" placeholder="Nombre del usuario" required>
            <span class="focus-input100" data-placeholder="&#xe82a;"></span>
        </div>
        <div class="wrap-input100 validate-input" data-validate = "Ingrese su correo">
            <input v-model="userFrom.email" class="input100" type="email" placeholder="Correo del usuario" required>
            <span class="focus-input100" data-placeholder="&#xe818;"></span>
        </div>

        <div class="wrap-input100 validate-input" data-validate="Ingrese password">
            <input v-model="userFrom.password" class="input100" type="password" placeholder="Contraseña" required>
            <span class="focus-input100" data-placeholder="&#xe80f;"></span>
        </div>
